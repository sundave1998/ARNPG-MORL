...
# Response to gegG
We thank the reviewer for the valuable feedback regarding the paper. Please see our responses below with respect to the specific comments.
...
**Please refer to newly attached pdf for details.**
...
**Q1.** " About the suboptimality gap $\delta_K$ and the convergence rate: ... convergence rate which is claimed in the abstract and in the contributions under 'mild assumptions’ (as it is stated) is actually 'asymptotic' "

  
  

**Response:** We would like to provide a more detailed discussion on the factor $\delta^k, \delta_K, \delta^*$ in Authors' Response to All. We will clarify the "asymptotic" property of results in abstract, contributions, and Table 1 in our final version.

  
  
  

**Q2.** "About Assumption 3.2: this technical assumption guarantees that is uniformly lower bounded away from zero but it seems hard to interpret or give a meaning to this assumption although the 'sub-optimality gap’ is a standard quantity in the bandit literature for instance.... "

  
  

**Response:** The reviewer is correct that it is hard to guarantee a lower bound on $\delta^k, \forall k$. Therefore, we proposed the theoretical relaxation with Corollary 3.6.1 based on $\delta^*$. **Please see the details in Authors' Response to All.**
...
**Q4.** "Regarding the definition of Markov potential games"
...
**Q5.** "Originality of the analysis"
...
- Yes, we used 'set of policies' to denote a joint policy of product simplices.

We will make sure to clarify at our first use of this specific term.
...
**Q8.** "The assumption of 'isolated stationary policies’ seems to be needed to guarantee that as stated in Theorem 3.6 (as it is also stated and used in [33]). However this assumption is not stated in the theorem. How does the theorem guarantee that $c>0$?"
...
**Q10.** "... isn’t it possible to use the assumption that the ‘stationary policies are isolated’ instead to obtain corollary 3.6.1? According to the comments l 248-250 in the paper (a short proof in the appendix may be useful then to state this implication properly), this assumption would guarantee that Assumption 3.2 hold."
...
**Q11.** "Could you please precise the mathematical definition of $\pi_i^{*k}$

? It seems to be only defined once with words in l. 134-135. "
...
**Q12.** "l. 153: why do we have that $f(\eta)\geq 0$?"
...
**Q13.** "Extension to the stochastic setting: "
